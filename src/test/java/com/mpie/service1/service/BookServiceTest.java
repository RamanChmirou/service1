...
public class BookServiceTest {
    ...
    public void testGetBooks() {
        ...
        List<Book> books = Arrays.asList(
                new Book("123", "Author 1", "Book 1", "Fiction", null),
                new Book("456", "Author 2", "Book 2", "Non-fiction", null)
        );
        when(bookRepository.findAll()).thenReturn(books);

        List<BookDto> expectedBookDtos = Arrays.asList(
                new BookDto("123", "Author 1", "Book 1", "Fiction", null),
                new BookDto("456", "Author 2", "Book 2", "Non-fiction", null)
        );
    ...
    public void testCreateBook() {
        // Given
        BookDto bookDto = new BookDto("123", "Author 1", "Book 1", "Fiction", null);
        Book bookEntity = new Book("123", "Author 1", "Book 1", "Fiction", null);
        when(bookMapper.toEntity(bookDto)).thenReturn(bookEntity);

        Book savedBookEntity = new Book("123", "Author 1", "Book 1", "Fiction", null);
        when(bookRepository.save(bookEntity)).thenReturn(savedBookEntity);

        BookDto expectedBookDto = new BookDto("123", "Author 1", "Book 1", "Fiction", null);
    ...
    public void testRentBook() {
        ...
        BookDto expectedBookDto = new BookDto("123", "Author 1", "Book 1", "Fiction", clientName);
    ...
    public void testRentBook_BookAlreadyRented() {
        ...
        Book alreadyRentedBook = new Book("123", "Author 1", "Book 1", "Fiction", "Alice");
